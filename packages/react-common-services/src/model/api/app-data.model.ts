...
export interface AppResponse {
	...
	model: AppModelResponse[];
	access?: string[];
	restrict?: RestrictResponse | Record<string, unknown>;
	allow?: RestrictResponse | Record<string, unknown>;
...
export interface FullAppDataResponse {
	...
	model?: AppModelResponse[];
	access?: string[];
	restrict?: Record<string, unknown> | RestrictResponse;
	allow?: Record<string, unknown> | RestrictResponse;

...
export const auth = {
	...
	login: (body: LoginRequest): Promise<LoginResponse> => api.post(`${AUTH_URL}/external/token`, { body }),

	refreshToken: (body: RefreshTokenRequest): Promise<LoginResponse> => api.post(`${AUTH_URL}/refresh`, { body }),

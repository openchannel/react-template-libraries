...
export class HttpRequestService {
	...
	post(url: string, body, options?: any): Observable<any> {
		return this.reInitCSRF(
			this.http.post<any>(this.environment.apiUrl + url, body, this.mergeHttpOptions(options)),
		);
	}
	...
	put(url: string, body, options?: any): Observable<any> {
		return this.reInitCSRF(
			this.http.put(this.environment.apiUrl + url, body, this.mergeHttpOptions(options)),
		);
	}
	...
	patch(url: string, body, options?: any): Observable<any> {
		return this.reInitCSRF(
			this.http.patch(this.environment.apiUrl + url, body, this.mergeHttpOptions(options)),
		);
	}
	...
	delete(url: string, options?: any): Observable<any> {
		return this.reInitCSRF(
			this.http.delete(this.environment.apiUrl + url, this.mergeHttpOptions(options)),
		);
	}
	...
	private initCSRF(): Observable<any> {
		return this.http.get(
			this.environment.apiUrl + AuthenticationService.INIT_CSRF_URL,
			this.options,
		);
	}

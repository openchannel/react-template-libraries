...
import { TooltipProps } from '@openchannel/react-common-components';
import OcTooltipComponent from 'packages/react-common-components/src/ui/common/atoms/oc-tooltip';

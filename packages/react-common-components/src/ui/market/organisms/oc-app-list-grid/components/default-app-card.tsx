		...
		<div className="app-list__card">
			<div className="app-list__card-wrapper">
				<div className="app-list__card-image">
					<img className="img-fluid" alt="" src={app.icon || app.customData?.icon || standardAppIcon} />
				</div>
				<div className="app-list__card-data">
					...
					<div className="app-list__card-info">
						...
						<OcRatingComponent rating={app.rating ? app.rating / 100 : 0} reviewCount={app.reviewCount} />
					</div>
				</div>

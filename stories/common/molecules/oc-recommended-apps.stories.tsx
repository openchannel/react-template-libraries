...
import { OcRecommendedAppsComponent, RecommendedAppsProps } from '../../../src/react-common-components/ui/common';
...
const RecommendedAppsComponent: Story<RecommendedAppsProps> = (args) => {
	return (
		<BrowserRouter>
			<OcRecommendedAppsComponent {...args} />
		</BrowserRouter>
	);
};

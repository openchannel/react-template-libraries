export const errorMessages = {
	...
	minCount: (): string => '',
	maxCount: (): string => '',
	minElementsCount: ({ requiredCount, fieldLabel }: { requiredCount: string | number, fieldLabel: string }): string => `Minimum ${requiredCount} ${fieldLabel} are required`,
	maxElementsCount: ({ requiredCount, fieldLabel }: { requiredCount: string | number, fieldLabel: string }): string => `Maximum ${requiredCount} ${fieldLabel} are required`,
	...
	booleanTagsValidator: ({ fieldTitle }: { fieldTitle: string }): string => `${fieldTitle} can only contain boolean values ('true' or 'false')`,
	numberTagsValidator: ({ fieldTitle }: { fieldTitle: string }): string => `${fieldTitle} can only contain numeric values`,
	passwordValidator: (): string => 'Password must contains 1 uppercase, 1 lowercase, 1 digit, 1 special char (one of @#$%!^&) and at least 8 character long',
